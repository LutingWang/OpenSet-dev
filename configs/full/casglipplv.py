        ...
        refine=dict(
            ...
            mil_classifiers=[
                dict(
                    ...
                    logits_weight=True,
                    tau=0.07,
                    loss_mil=dict(type='FocalWithLogitsLoss', weight=16),
                    loss_image_kd=dict(type='L1Loss', weight=64)),
                dict(
                    type='GAPClassifier',
                    kappa=32,
                    logits_weight=True,
                    tau=0.07,
                    loss_mil=dict(type='FocalWithLogitsLoss', weight=8),
                    loss_image_kd=dict(type='L1Loss', weight=64)),
                dict(
                    type='GAPClassifier',
                    kappa=16,
                    logits_weight=True,
                    tau=0.07,
                    loss_mil=dict(type='FocalWithLogitsLoss', weight=4),
                    loss_image_kd=dict(type='L1Loss', weight=64))
            ])),
    plv_refine=dict(
        hidden_dim=512,
        mil_classifier=dict(
            ...
            logits_weight=True,
            tau=0.007,
            loss_mil=dict(type='FocalWithLogitsLoss', weight=2),
            loss_image_kd=dict(type='L1Loss', weight=64))))
